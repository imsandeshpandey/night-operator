...
function Theme(background, accent) {
  this.name = "Night Operator";
  this.$schema = "vscode://schemas/color-theme";
  this.colors = {
    "activityBar.background": background,
    "activityBar.border": background + "00",
    "breadcrumb.background": background + "00",
    ...
    "titleBar.border": background + "00",
    "titleBar.inactiveBackground": background,
    "sideBar.background": background,
    "sideBar.border": background + "60",
    "sideBarSectionHeader.background": background + "40",
    "sideBarSectionHeader.border": background + "60",
    "statusBar.background": background,
    "statusBar.border": background + "60",
    "scrollbar.shadow": background + "00",
    ...
    "input.background": accent + "12",
    "statusBarItem.hoverBackground": accent + "20",
    ...
    "editorIndentGuide.activeBackground1": accent + "90",
